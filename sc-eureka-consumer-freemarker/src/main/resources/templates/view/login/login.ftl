...
<head>
    ...
    <meta name="copyright" content="RoyalBlue。All Rights Reserved">
...
<body>
	...
	<div class="container">
		<form action="${ctx }/login" class="form-signin" id="userForm" method="POST">
			...
			<input type="text" class="form-control input-block-level" id="username" name="username" placeholder="用户" value="zhengjing">
